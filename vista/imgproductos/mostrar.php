     ...
     <div class="container-fluid">
      <div class="row">
             ...
             <div class="col-lg-6">
                 <div class="card card-info">
                     <div class="card-header">
                         <h3 class="card-title">Ingresar Nueva Imagen</h3>
                     </div> <!-- ./ end card-header -->
                     <div class="card-body">
                         <div class="row">
                            <div class="col-lg-12 d-lg-flex">
         ...
         <div class="row">
             <div class="col-lg-12">
                ...
                <tr  class="articulo">
                    ...
                    <td><?=$c["nombre"]?></td>
                    <td>
                    <a href="?ctrl=Ctrlimagenes_producto&accion=editar&idimagen=<?=$c["idimagen"]?>">
                    <i class="bi bi-pencil-square"></i> Editar </a>
                    / 
                    <a href="?ctrl=Ctrlimagenes_producto&accion=eliminar&idimagen=<?=$c["idimagen"]?>">
