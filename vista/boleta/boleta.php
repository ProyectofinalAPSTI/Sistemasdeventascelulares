    ...
    <div class="row">
      <div class="col-12">
        <h2 class="page-header">
          <i class="fas fa-globe"></i> SMARTPHONE PERU
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <address>
          ...
          Phone: 053-465211<br>
          Email: SmartphonePeru.@gmail.com<br>
          RUC: 20123456787
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          <br>
          <b>Nombre:</b> <?=$data[0]['nombrecli']?><br>
          <b>Apellido:</b> <?=$data[0]['apellidocli']?><br>
          <b>Direccion:</b> <?=$data[0]['direccion']?><br>
          <b>DNI:</b> <?=$data[0]['dni']?><br>
          <b>Telefono:</b><?=$data[0]['telefono']?><br> <br>
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <b>Monto: </b>S/ <?=number_format($data[0]['total']*1.18, 2, ',', ' ')?><br>
      ...
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th>Total:</th>
              <td>S/ <?=number_format($data[0]['total']*1.18, 2, ',', ' ')?></td>
            </tr>
          </table>
        </div>
      </div>
